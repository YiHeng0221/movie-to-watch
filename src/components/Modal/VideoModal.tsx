...
const VideoModal = ({ videoSrc, onClose }: { videoSrc: string, onClose: () => void }) => {
  return (
    <div className="w-full h-screen bg-black fixed z-50 top-0 left-0 flex justify-center items-center bg-opacity-50 backdrop-blur-md">
        ...
        <iframe width="1080" height="720" src={videoSrc} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
    </div>
  );
};
